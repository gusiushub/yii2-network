     ...
     <div class="panel-heading">
      <header class="panel-title">
       <div class="text-center">
        <strong>Номер пользователя на сайте - <?php echo $user['id'] ?></strong>
       </div>
      </header>
     </div>
      ...
      <div id="myTabContent" class="tab-content">
       ...
       <div class="tab-pane fade active in" id="detail">
        ...
        <table class="table table-th-block">
         <tbody>
         <tr><td class="active">Дата регистрации:</td>
             <td>
                 <?php
                 $dateReg = getdate($user['created_at']);
                 echo $dateReg['mday'] . ' . ' . $dateReg['mon'] . ' . ' . $dateReg['year']; // 12.12.2014
                 ?>
             </td>
         </tr>
...
<!--         <tr><td class="active">Город:</td><td>Волгоград</td></tr>-->
         <tr><td class="active">Пол:</td><td><?php echo $user['sex'] ?></td></tr>
